...
namespace SchoolApplicationCoreApp.Utilitie
{
    public static class EfExtension
    {
        public static IServiceCollection AddEntityFramework(this IServiceCollection services, string connectionString)
        {
            services.AddDbContext<DatabaseContext>(options => options.UseSqlServer(connectionString, x => x.MigrationsAssembly("SchoolApplicationCoreApp")));
